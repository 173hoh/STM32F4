...
float Balance_Kp=35500,Balance_Kd=115,Velocity_Kp=16000,Velocity_Ki=90,Turn_Kp=4200,Turn_Kd=0;//PID参数（放大100倍）
//float Balance_Kp=35000,Balance_Kd=108,Velocity_Kp=16000,Velocity_Ki=90,Turn_Kp=4200,Turn_Kd=0;//PID参数（放大100倍）//自己的


int main(void)
{ 
	for(int aaa=0;aaa<100;aaa++)
		for(int bbb=0;bbb<50000;bbb++)
