...
void PWM_Init_TIM2(u16 Psc,u16 Per)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB1Periph_TIM2 | RCC_APB2Periph_AFIO,ENABLE);//开启时钟
	...
	TIM_OC4PreloadConfig(TIM2,TIM_OCPreload_Enable);//ENABLE//OC4预装载寄存器使能
