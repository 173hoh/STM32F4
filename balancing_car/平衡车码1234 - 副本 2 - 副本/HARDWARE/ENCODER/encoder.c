...
void Encoder_TIM3_Init(void)
{
	...
	GPIO_InitStruct.GPIO_Mode=GPIO_Mode_IN_FLOATING;//初始化GPIO--PA6、PA7，浮空输入
	GPIO_InitStruct.GPIO_Pin=GPIO_Pin_6 |GPIO_Pin_7;//定时器3引脚
	...
	TIM_ClearFlag(TIM3,TIM_FLAG_Update);//溢出清除
